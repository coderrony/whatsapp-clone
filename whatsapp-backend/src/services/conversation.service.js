...
export const doesConversationExist = async (
  ...
  if (isGroup === false) {
    let convos = await ConversationModel.find({
      ...
      .populate("latestMessage"); // if not get convos [] and get convos [{....}]
    ...
    return  convos.length > 0 ? convos[0] : false;
  } else {
    //it's a group chat
    let convo = await ConversationModel.findById(isGroup) // isGroup like   isGroup: '685180a0d32cdaf948b82d76'
